...
\restrict gulmyeWXPJhiAWbparglutpvDm57dm7YTQ9XtNZufE84aBdJSTKgUKenkJnIopW
...
--
-- Name: home_settings; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.home_settings OWNER TO postgres;

--
-- Name: home_settings_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.home_settings_id_seq OWNER TO postgres;

--
-- Name: home_settings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: home_settings id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: home_settings; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: home_settings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: home_settings home_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ratings ratings_listing_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ratings fk_user_ratings; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict gulmyeWXPJhiAWbparglutpvDm57dm7YTQ9XtNZufE84aBdJSTKgUKenkJnIopW
